...
def prepareHotVectorsWithFeatures(train_tensor, labels_tensor, features_tensor):
...
#true is used for training; false is used for testing
...
def performEvaluation(TEST_MODEL_COMPILED, test_Set):
	...
	for index in xrange(n_batches):
		...
		xf, xb, y, featsSlice, mask, nVisitsOfEachPatient_List = prepareHotVectorsWithFeatures(batchX, batchY, batchT)
